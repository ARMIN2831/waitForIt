<div class="w-full p-2 flex flex-row justify-between items-center relative">
    ...
    <input wire:change.debounce.1000ms="optionsHandle('{{ $attributes['section'] }}' ,'{{ $attributes['index'] }}',$event.target.files[0])" wire:model="photo" type="file" class="opacity-0 absolute left-0" />
</div>

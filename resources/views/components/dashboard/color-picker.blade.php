<div class="w-full p-2 flex flex-row justify-between items-center">
    ...
    <div class="relative">
        ...
        <input wire:change="optionsHandle('{{ $attributes['section'] }}' ,'{{ $attributes['index'] }}',$event.target.value)" onchange="colorPicker(this)" type="color" class="w-8 h-8 cursor-pointer border-none opacity-0" value="{{ $attributes['value'] }}">
    </div>
</div>

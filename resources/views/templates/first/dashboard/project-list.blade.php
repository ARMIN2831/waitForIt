<div x-data=" { create: false } " class="py-4 px-3">
    ...
    @foreach($projects as $project)
        <div class="z-30 w-full h-12 bg-gray-300 cursor-pointer border border-gray-400 my-2 transition duration-300 ease-in-out transform hover:scale-95 hover:shadow flex flex-row justify-between items-center px-4">
            ...
            <div class="transition duration-300 ease-in-out group">
                ...
                <ul class="absolute bg-white border border-black rounded-sm right-4 hidden group-hover:block z-40">

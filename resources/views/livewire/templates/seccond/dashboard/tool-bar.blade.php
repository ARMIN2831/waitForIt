<div x-data="{ activeTab: 'general' }" class="py-4 px-3">
    <ul class="w-full bg-gray-700 p-2 flex flex-row justify-between">
        <li @click="activeTab = 'general'"
            :class="{ 'bg-gray-800': activeTab === 'general', 'hover:bg-gray-600': activeTab !== 'general' }"
            class="text-center font-semibold cursor-pointer px-1 py-0.5 w-[80px] border border-gray-600 rounded-sm shadow-lg">
            General
        </li>
        <li @click="activeTab = 'input'"
            :class="{ 'bg-gray-800': activeTab === 'input', 'hover:bg-gray-600': activeTab !== 'input' }"
            class="text-center font-semibold cursor-pointer px-1 py-0.5 w-[80px] border border-gray-600 rounded-sm shadow-lg">
            Input
        </li>
        <li @click="activeTab = 'button'"
            :class="{ 'bg-gray-800': activeTab === 'button', 'hover:bg-gray-600': activeTab !== 'button' }"
            class="text-center font-semibold cursor-pointer px-1 py-0.5 w-[80px] border border-gray-600 rounded-sm shadow-lg">
            Button
        </li>
    </ul>
